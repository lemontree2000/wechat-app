...
App({
  ...
  globalData:{
    userInfo:null,
    subDomain: "yxmall", //tz 如果你的域名是： https://api.it120.cc/abcd 那么这里只要填写 abcd
    version: "4.1.0",
    note:'增加小程序购物单支持',
    appid: "wxc060ca1ce3c418de", // 您的小程序的appid
    shareProfile: '百款精品商品，总有一款适合您', // 首页转发的时候话术
    isConnected: true, // 网络是否连接
    _path: 'https://api.it120.cc/yxmall' // 原项目路由配置在页面中，改为配置项
  }
  /*
